module.exports = function(app) {
  ...
  usersRouter.post('/', function(req, res) {
    ...
    // Look for the most recently created record and use it to set the id field of our incoming recode, which is required by Ember Data
    userDB.find({}).sort({id : -1}).limit(1).exec(function(err,users) {
      ...
      // Insert the new record into our data store, and return the newly created record to Ember Data
